...
$deal_id = 0;
$alert_result = mysql_query("SELECT * FROM user2deal WHERE date_sent = NULL"); // Pull all deals that have not yet been sent
while ($contact_array = mysql_fetch_array($alert_result)){           // For this deal, generate an email
...
$mail->Subject = $contact_array['fname'] . ", " . 'You have a new deal!';
