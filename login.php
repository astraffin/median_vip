...
<?php
			...
			$query = mysql_query("SELECT user_id, fname, lname, is_setup, is_dealer FROM users WHERE username = '" . $username . "' AND hashed_password = '" . $hashed_password . "' LIMIT 1");
